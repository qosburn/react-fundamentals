    ...
    <div className="main">
      <div className="mainDiv">
        <input
          ...
          placeholder="enter you sw character number"
        />
...
const useNumHook = (num) => {
  ...
  useEffect(() => {
    if (queryNum !== '') {
      fetch(`https://numbersapi.com/${queryNum}`) // this url is wrong.. you can change to the starwars one to makes ure it is pulling but the text will not be formed.
        .then((res) => res.text())
        .then((json) => {
          console.log(json);
          setResults(json);
